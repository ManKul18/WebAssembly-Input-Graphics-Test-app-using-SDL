...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '../output/test_mouse.data';
    var REMOTE_PACKAGE_BASE = 'test_mouse.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_../output/test_mouse.data');

    };
    Module['addRunDependency']('datafile_../output/test_mouse.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 52378, "filename": "/spaceship.bmp"}, {"start": 52378, "audio": 0, "end": 70424, "filename": "/missile.bmp"}], "remote_package_size": 70424, "package_uuid": "6b54b53f-84ff-4cae-966c-083911c19079"});
...
var wasmBinaryFile = 'test_mouse.wasm';
