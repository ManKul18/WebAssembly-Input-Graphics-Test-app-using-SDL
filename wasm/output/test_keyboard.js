...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '../output/test_keyboard.data';
    var REMOTE_PACKAGE_BASE = 'test_keyboard.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_../output/test_keyboard.data');

    };
    Module['addRunDependency']('datafile_../output/test_keyboard.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 52378, "filename": "/spaceship.bmp"}, {"start": 52378, "audio": 0, "end": 70424, "filename": "/missile.bmp"}], "remote_package_size": 70424, "package_uuid": "a08b5569-7272-4fd1-bbc6-f62d6b66c0bd"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 69312,
    DYNAMIC_BASE = 5312192,
    DYNAMICTOP_PTR = 69280;
...
var wasmBinaryFile = 'test_keyboard.wasm';
...
// STATICTOP = STATIC_BASE + 68288;
/* global initializers */  __ATINIT__.push({ func: function() { ___wasm_call_ctors() } });



/* no memory initializer */
var tempDoublePtr = 69296
