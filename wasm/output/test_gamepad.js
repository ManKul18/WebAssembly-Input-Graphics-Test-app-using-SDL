...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '../output/test_gamepad.data';
    var REMOTE_PACKAGE_BASE = 'test_gamepad.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_../output/test_gamepad.data');

    };
    Module['addRunDependency']('datafile_../output/test_gamepad.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 52378, "filename": "/spaceship.bmp"}, {"start": 52378, "audio": 0, "end": 70424, "filename": "/missile.bmp"}], "remote_package_size": 70424, "package_uuid": "86f8c55d-8cb3-4e38-9027-dd8731fe1a4a"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 65824,
    DYNAMIC_BASE = 5308704,
    DYNAMICTOP_PTR = 65792;
...
var wasmBinaryFile = 'test_gamepad.wasm';
...
// STATICTOP = STATIC_BASE + 64800;
/* global initializers */  __ATINIT__.push({ func: function() { ___wasm_call_ctors() } });



/* no memory initializer */
var tempDoublePtr = 65808
